...
* nRF52833 (QDAA-B) - relatively low cost, available from Mouser, integrated radio transceiver supporting Nordic Enhanced Shockburst protocol (same as the popular nRF24L01+ - lower latency and better data rate than alternatives like ESP-NOW), small package (5x5 mm), 512 kB integrated flash memory, enough GPIO pins, floating-point unit for controls and sensor-fusion algorithms
